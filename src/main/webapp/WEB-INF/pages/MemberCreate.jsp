				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						...
						<input type="text" class="form-control" maxlength="10"
							name="userid" required id="userid" placeholder="(英文首字大小寫皆可)">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" maxlength="15" name="pwd"
							required id="pwd" placeholder="(15個英文字元內)">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="gender"
							maxlength="1" required id="gender" placeholder="(請填入男或女)">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" maxlength="11" name="tele"
							required id="tele" placeholder="(02-87654321)">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" maxlength="30"
							name="address" required id="address">
					</div>
				</div>
...
<!--                    <img class="img-fluid mx-auto mb-4" id="preview_progressbarTW_img" src="#" 
							alt="請選擇您的照片" style="width: 260px; height: 320px;"> -->
