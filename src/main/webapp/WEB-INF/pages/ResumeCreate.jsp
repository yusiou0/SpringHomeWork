		...
		<div class="col-sm-12 col-xl-10">
			<div class="bg-light rounded h-100 p-4">
				...
				<div>
					...
					<form action="<c:url value='/resume'/>" method="post" onsubmit="return checkResumeForm()">
...
5.工作內容及成效..."
						...
						<div class="center">
							...
							<button type="reset" class="btn btn-primary">清除內容</button>
							 <button type="button" class="btn btn-primary" onclick='location.href="<c:url value='/resumes'/>"'>取消新增</button>
						</div>
					</form>
				</div>
